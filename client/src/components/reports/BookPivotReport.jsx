...
//   dataFromServer.forEach(({ role_name, employees, isMonthly = false }) => {
...
// const BookMatrixReport = ({ initialBook, onBack }) => {
...
//         console.log("Transformed matrix data:", transformed);
...
//     saveAs(blob, `${t("bookMatrixReport.fileName") || "Matrix_Report"}_${selectedBookId}.xlsx`);
//   };
