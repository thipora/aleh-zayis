...
// import { formatCurrency, calculateTotalsByCurrency } from "../../utils/formatters";
...
//   return { roles, employees, totalsByRole, grandTotal, totalsByCurrency };
// }
...
//                       {matrixData.totalsByRole[role]
//                         ? `${formatCurrency(matrixData.currency)} ${matrixData.totalsByRole[role].toFixed(2)}`
//                         : ""}
//                     </TableCell>
//                   ))}
...
//                     {/* {matrixData.grandTotal.toFixed(2)
//                       ? `${formatCurrency(matrixData.currency)} ${matrixData.grandTotal.toFixed(2)}`
//                       : ""} */}
...
const BookMatrixReport = () => {
  ...
  const exportToExcel = () => {
    // כמו קודם - אם תרצי אפשר גם להוסיף totalsByCurrency ל־Excel
  };
