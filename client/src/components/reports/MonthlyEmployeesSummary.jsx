...
//     const wsData = summary.map(emp => ({
//       "שם עובד": emp.employee_name,
//       "סוג": emp.type === "hours" ? "שעות" : emp.unit,
//       "תעריף (₪)": emp.rate,
//       "סה\"כ יחידות": parseFloat(emp.quantity).toFixed(2),
...
//       "סוג": "",
//       "תעריף (₪)": "",
//       "סה\"כ יחידות": summary.reduce((sum, e) => sum + Number(e.quantity), 0).toFixed(2),
...
//                 >
//                   <TableCell>{emp.employee_name}</TableCell>
//                   <TableCell align="center">{emp.type === "hours" ? "שעות" : "כמות"}</TableCell>
//                   <TableCell align="center">{emp.type === "hours" ? "שעות" : emp.unit}</TableCell>
//                   <TableCell align="center">{emp.rate}</TableCell>
//                   <TableCell align="center">{parseFloat(emp.quantity).toFixed(2)}</TableCell>
...
//                 <TableCell />
//                 <TableCell align="center" sx={{ fontWeight: "bold" }}>
//                   {summary.reduce((sum, e) => sum + Number(e.quantity), 0).toFixed(2)}
//                 </TableCell>
//                 <TableCell align="center" sx={{ fontWeight: "bold" }}>
