...
import {
  ...
  DialogActions, TextField, Box, Table, TableHead, TableBody, TableRow, TableCell
} from "@mui/material";
...
const MonthlyCharges = ({ employeeId }) => {
  ...
  const fetchCharges = async () => {
    try {
      const data = await api.getRequest(`/monthly-charges/by-employee/${employeeId}`);
      setCharges(data);
    } catch (err) {
